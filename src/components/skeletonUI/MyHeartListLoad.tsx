const MyHeartListLoad = () => {
  return (
    <div className="relative w-full full-height overflow-hidden px-5 mx-auto max-w-screen-lg bg-purple-50">
      <div className="pb-3 grid grid-cols-5 gap-x-4 animate-pulse">
      ...
      <div className="flex justify-end">
        <div className="w-[76px] h-[32px] rounded-full mt-2 bg-gray-300"></div>
      </div>
      {Array.from(Array(2)).map((_, index) => (
        <div className="pb-14 animate-pulse" key={index}>
          <div className="w-[80px] h-[24px] rounded bg-gray-300 mt-3 mb-4 text-xl font-semibold"></div>
          <div className="grid grid-cols-2 gap-x-4 gap-y-12 items-start">
